...
def addBinaries(a: str,
                b: str,
                return_carry=False,
                *,
                outer_carry: str = '0') -> (str, str):
  a, b = a[::-1], b[::-1]
...
class Straight:
  ...
  def valid(self) -> bool:
    return set(self.sign) in ('1', '0') and set(self.binary_repr) in ('1', '0')
...
class Extended(Straight):
  ...
  def __neg__(self):
    return Extended(inverseBits(self.sign),
                    addBinaries(inverseBits(self.binary_repr), '1')[0])
